## robot_state_publisher (kilted) - 3.4.4-1

The packages in the `robot_state_publisher` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted robot_state_publisher` on `Fri, 04 Sep 2026 11:03:27 -0000`
...
## robot_state_publisher (rolling) - 3.6.1-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Tue, 30 Jun 2026 08:23:38 -0000`
...
## robot_state_publisher (jazzy) - 3.3.4-1

The packages in the `robot_state_publisher` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy robot_state_publisher` on `Tue, 02 Jun 2026 04:09:18 -0000`
...
## robot_state_publisher (rolling) - 3.6.0-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling robot_state_publisher` on `Wed, 06 May 2026 18:55:25 -0000`
...
## robot_state_publisher (rolling) - 3.5.5-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Thu, 09 Apr 2026 08:54:39 -0000`
...
## robot_state_publisher (rolling) - 3.5.4-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Fri, 09 Jan 2026 11:41:27 -0000`
...
## robot_state_publisher (rolling) - 3.5.2-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Fri, 18 Jul 2025 09:04:11 -0000`
...
## robot_state_publisher (rolling) - 3.5.1-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Mon, 19 May 2025 07:53:34 -0000`
...
## robot_state_publisher (rolling) - 3.5.0-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release robot_state_publisher -r rolling` on `Sat, 26 Apr 2025 02:09:49 -0000`
...
## robot_state_publisher (rolling) - 3.4.2-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling robot_state_publisher` on `Fri, 20 Dec 2024 16:32:16 -0000`
...
## robot_state_publisher (rolling) - 3.4.1-1

The packages in the `robot_state_publisher` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling robot_state_publisher` on `Wed, 28 Aug 2024 20:21:33 -0000`
