## robot_state_publisher (foxy) - 2.3.0-1

The packages in the `robot_state_publisher` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy --track foxy robot_state_publisher` on `Thu, 30 Apr 2020 18:27:29 -0000`
